...
public class BEE1010 {
    public static void main(String[] args) {
        ...
        double precoUnitario_peca1 = sc.nextDouble();

        int codigoPeca2 = sc.nextInt();
        int numeroPeca2 = sc.nextInt();
        double precoUnitario_peca2 = sc.nextDouble();

        // Processo
        double total = (numeroPeca1 * precoUnitario_peca1) + (numeroPeca2 * precoUnitario_peca2);
        
        // Saida
        System.out.printf("Cód %d%n", codigoPeca1);
        System.out.printf("Cód %d%n", codigoPeca2);
